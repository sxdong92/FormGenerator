...
<div class="row marketing">
	<form id="form1" action="generateNotice.do" onsubmit="return validateForm()"
		method="post">
		<div class="content-row">
			...
			<h4>What opt out communication methods will you offer? (At least
				one) *</h4>
			<div id="error1" style="display: none">
				<h5 style="color: red;">You must select at least one opt-out
					method.</h5>
			</div>

			<table style="width: 100%">
				<tr>
					<td width="15%"><input type="checkbox" name="opt-out"
						value="1"> Phone</td>
					<td width="15%"><input type="checkbox" name="opt-out"
						value="2"> Website</td>
					<td width="15%"><input type="checkbox" name="opt-out"
						value="4"> Mail-in</td>
					<td><input type="checkbox" name="opt-out" value="8">
						Third Party Cookie OptOut <a
						href="http://www.allaboutcookies.org/manage-cookies/opt-out-cookies.html"
						target="_blank"><span
							class="glyphicon glyphicon-question-sign"></span></a></td>
					<td><input type="checkbox" name="opt-out" value="16">
						Do Not Track Plugin <a
						href="http://en.wikipedia.org/wiki/DoNotTrackMe" target="_blank"><span
							class="glyphicon glyphicon-question-sign"></span></a></td>
				</tr>
			</table>
			<br />

			<h4>Please select Yes if any of the following statements is
				true: *</h4>
			<ul>
			...
			<table style="width: 40%">
				<tr>
					<td><input type="radio" name="optionsRadio2" id="radio3"
						value="many" checked> Yes</td>
					<td><input type="radio" name="optionsRadio2" id="radio4"
						value="one"> No</td>
				</tr>
			</table>
			<br />
		...
		<div class="content-row">
			...
			<h4>Please list the financial institutions that jointly provide
				this notice.*</h4>
			...
			<div id="div3">
				<p>
					<textarea id="question0" name="question0" class="form-control"
						rows="4"></textarea>
				</p>
			</div>
			<br />
		...
		<div class="content-row">
			...
			<div class="content-row">
				...
				<div id="error2" style="display: none">
					<h5 style="color: red;">The field need to be exactly five
						methods</h5>
				</div>
				<div id="error5" style="display: none">
					<h5 style="color: red;">You need to select 6 options including
						SSN so only need to select 5 in total besides SSN</h5>
				</div>
				...
				<div id="addssninput" onclick="checkBox()">
					<table>
						<tr>
							<td><input type="checkbox" name="checkbox"
								value="Open an account"> Open an account</td>
								
							<td><input type="checkbox" name="checkbox"
								value="Deposit money"> Deposit money</td>
							<td><input type="checkbox" name="checkbox"
								value="Make
									deposits or withdrawals from your account">
								Make deposits or withdrawals from your account</td>
							<td><input type="checkbox" name="checkbox"
								value="Pay your bills"> Pay your bills</td>
						</tr>
						
						<tr>
							<td><input type="checkbox" name="checkbox"
								value="Apply for a loan"> Apply for a loan</td>
							<td><input type="checkbox" name="checkbox"
								value="Use your credit or debit card"> Use your credit
								or debit card</td>
							<td><input type="checkbox" name="checkbox"
								value="Seek financial or tax advice"> Seek financial or
								tax advice</td>
							<td><input type="checkbox" name="checkbox"
								value="Seek advice about your investments"> Seek advice
								about your investments</td>
						</tr>
						
						<tr>
							<td><input type="checkbox" name="checkbox"
								value="Apply for insurance"> Apply for insurance</td>
							<td><input type="checkbox" name="checkbox"
								value="Pay insurance premiums"> Pay insurance premiums</td>
							<td><input type="checkbox" name="checkbox"
								value="File an insurance claim"> File an insurance claim</td>
							<td><input type="checkbox" name="checkbox"
								value="Buy securities from us"> Buy securities from us</td>
						</tr>
						<tr>
							<td><input type="checkbox" name="checkbox"
								value="Sell securities to us"> Sell securities to us</td>
							<td><input type="checkbox" name="checkbox"
								value="Direct us to buy securities"> Direct us to buy
								securities</td>
							<td><input type="checkbox" name="checkbox"
								value="Direct us to sell your securities"> Direct us to
								sell your securities</td>
							<td><input type="checkbox" name="checkbox"
						...
						<tr>
							<td><input type="checkbox" name="checkbox"
								value="Give us your income information"> Give us your
								income information</td>
							<td><input type="checkbox" name="checkbox"
								value="Provide employment information"> Provide
								employment information</td>
							<td><input type="checkbox" name="checkbox"
								value="Give us your employment history"> Give us your
						...
						<tr>
							...
							<td><input type="checkbox" name="checkbox"
								value="Apply for financing"> Apply for financing</td>
							<td><input type="checkbox" name="checkbox"
								value="Apply for a lease"> Apply for a lease</td>
							<td><input type="checkbox" name="checkbox"
								value="Provide account information"> Provide account
								information</td>
						</tr>
						<tr>
							<td><input type="checkbox" name="checkbox"
								value="Give us your contact information"> Give us your
								contact information</td>
							<td><input type="checkbox" name="checkbox"
								value="Pay us by check"> Pay us by check</td>
							<td><input type="checkbox" name="checkbox"
								value="Give us your wage statements"> Give us your wage
								statements</td>
							<td><input type="checkbox" name="checkbox"
								value="Provide your mortgage information"> Provide your mortgage information</td>
						</tr>

						<tr>
							<td><input type="checkbox" name="checkbox"
								value="Make a wire transfer">
								Make a wire transfer</td>
							<td><input type="checkbox" name="checkbox"
								value="Tell us who receives the money"> Tell us who receives the money</td>
							<td><input type="checkbox" name="checkbox"
								value="Tell us where to send the money"> Tell us where to send the money</td>
							<td><input type="checkbox" name="checkbox"
								value="Show your government-issued ID"> Show your government-issued ID</td>
						</tr>
						...
						<tr>
							...
							<td><input type="checkbox" name="checkbox"
								value="Order a commodity futures or option trade"> Order a commodity futures or option trade</td>
							<td></td>
							<td></td>
						</tr>
		...
		<!--<h4>What is the reason you don't allow user to limit all
			...
			<br />-->
		<h4>Do you collect users' personal information from your
			affiliates and/or credit bureaus?</h4>
		<div class="radio">
			<label> <input type="radio" name="collect" id="Collect"
				value="yes" onclick="block(this)" checked> Yes
			</label>
		</div>
		<div class="radio">
			<label> <input type="radio" name="collect" id="Collect"
				value="no" onclick="show(this)"> No
			</label>
		</div>
		...
		<div class="leftpad" id="collect2div" style="display: none">
			...
			<div class="radio">
				<label> <input type="radio" name="collect2" id="Collect2"
		...
		<h4>Will you refer to state laws for the question "Why can't
			customers limit all sharing" ?</h4>
		<div class="radio">
			<label> <input type="radio" name="refer" id="StateLaw"
				value="yes" onclick="showDescription(this)"> Yes
			</label>
		</div>
		<div class="radio">
			<label> <input type="radio" name="refer" id="StateLaw"
				value="no" onclick="blockDescription(this)" checked> No
			</label>
		</div>
		<div class="leftpad" id="LawDescription" style="display: none">
			<h5>Please describe the state law provisions you will refer to
				here.</h5>
			<p>
		...
		<h4>
			What happens when a customer limit sharing for an account he hold <br />jointly
			with someone else? *
		</h4>
		<div class="radio">
			<label> <input type="radio" name="radios" id="LimitShare1"
				value="radio1" checked> "Your choices will apply to everyone
				on your account."
			</label>
		</div>
		<div class="radio">
			<label> <input type="radio" name="radios" id="LimitShare2"
				value="radio2"> "Your choices will apply to everyone on your
...
<div class="content-row">
	...
	<div id="div1">
		...
		<p>
			<textarea id="t11" name="question5_1" id="question5_1"
				class="form-control" rows="4"></textarea>
		</p>
		<label>Nonfinancial companies:</label>
		<p>
			<textarea id="t12" name="question5_2" id="question5_2"
				class="form-control" rows="4"></textarea>
		</p>
		<label>Others:</label>
		<p>
			<textarea id="t13" name="question5_3" id="question5_3"
				class="form-control" rows="4"></textarea>
		</p>
	</div>
	<br />
	...
	<p>
		<textarea id="t4" name="question8" class="form-control" id="question8"
			rows="5"
...
(2) Acknowledgment of receipt form."></textarea>
	...
	<p align="center">
		<button type="submit" class="btn btn-primary btn-primary-lg"
			name="next2" value="true">Generate Privacy Form</button>
	</p>
</div>
